            ...
            <section class="content">
               <div class="row">
                  ...
                  <div class="col-md-6">
					 ...
					 <!--
                     <a href="#" class="btn btn-primary btn-block margin-center">Get started</a>
                     <a href="#" class="btn btn-primary btn-block margin-center">Troubleshoot</a>
                     <a href="#" class="btn btn-primary btn-block margin-center">Request a new feature</a>
                     <a href="#" class="btn btn-primary btn-block margin-center">Personalize MITRA</a>
                     <a href="#" class="btn btn-primary btn-block margin-center">FAQ's</a>
                     <a href="#" class="btn btn-primary btn-block margin-center">Contact</a>
                     <!-- /.box -->
                  </div>
               </div>
               <!-- /.row -->
